...
export const StatusRow = ({row,selectedRow,handleSelectedRow,handleStatusOption})=>{
  ...
  const [hovered,setHovered] = useState(false);
    ...
    return (
        ...
        >
          <span className={` decoration-dotted underline underline-offset-[4px] cursor-context-menu font-semibold ${row.values.status === 'Open' ? 'text-red-500' : 'text-blue-500'}`}>{row.values.status}</span> 
